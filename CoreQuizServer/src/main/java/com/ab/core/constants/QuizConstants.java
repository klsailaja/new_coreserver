...
private static final String OS_ROOT = "D:";
	...
	public static boolean GAME_MODE;
	
	// When GAME_MODE is 1 means purely money mode, 2 means coins and reimbursement the coins
	// and 3 means purely coins
	// When the GMAE_MODE is 2 COIN_BUY_RATE and COIN_SELL_RATE are used.
